...
function isMultipleOf5(val) {
    ...
    // onde foi colocado o operador ===, que indica que se o resultado for 0, ou seja, o operador % indica o resto
    //  da operação de divisão, ou seja se o resultado for 0,o número será um multiplo de 5, ou seja com o operador
    //  === se o resultado for 0, o cálculo será perfeito;
    return (val % 5 === 0);
}
